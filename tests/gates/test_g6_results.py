...
def test_headroom_keys_the_cell_by_BACKBONE_and_refuses_when_it_cannot():
    ...
    parts = ("results", "dom1", "MobileNetV2", "fmow2", "L80_G95", "tralo", "seed_1")
    assert run_axes(parts) == ("MobileNetV2", "fmow2")
    other = ("results", "dom1", "MobileNetV3", "fmow2", "L80_G95", "tralo", "seed_1")
    ...
    with pytest.raises(SystemExit):
        run_axes(("seed_1",))
    with pytest.raises(SystemExit):
        run_axes(("fmow2", "L80_G95", "tralo", "seed_1"))
