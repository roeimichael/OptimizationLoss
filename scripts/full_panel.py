...
def _items_scale(rows):
    ...
    **dermmnist** NUMBER AND MUST NOT BE READ AS THE EFFECT SPACE. It was
    ...
    print("  A delta smaller than ONE item is not a delta -- it is a different")
    print("  allocation of the same predictions, and several archived results")
    print("  sit below that line.")
    print("  !! DO NOT quote a remembered effect-space band here. The old")
    print("     `1.9-9.9 items PER CLASS, paired seed sd ~2.7` printed at this")
    print("     spot is a dermmnist number, from the removed 38.7%-leaking")
    print("     dataset, and predates iwildcam. On iwildcam the prize is")
    print("     regime-dependent: roughly 0.2-0.7 items/class at the retired")
    print("     tight caps against 7-31 at the live loose ones. Use the")
    print("     per-cell scale printed above. FRAMEWORK 2(z32)d.")
    print()
