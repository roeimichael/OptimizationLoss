...
Scope (1008 cells):
  MobileNetV3        x {tissue,derm,oct} x 6 methods x 7 diagonal tags x seeds 1-4 = 504  (figure+tables)
  MobileNetV2/RegNet x {tissue,derm,oct} x 6 methods x {L30,L50,L70}   x seeds 1-4 = 432  (tables)
  ViTB16             x {oct}             x 6 methods x {L30,L50,L70}   x seeds 1-4 =  72  (table)
"""
import json
import os
import sys
...
ALL_TAGS = ["L20_G20", "L30_G30", "L40_G40", "L50_G50", "L60_G60", "L70_G70", "L80_G80"]
TABLE_TAGS = ["L30_G30", "L50_G50", "L70_G70"]
SEEDS = [1, 2, 3, 4]
SCOPE = [  # (model, datasets, tags)
    ("MobileNetV3", ["tissuemnist", "dermmnist", "octmnist"], ALL_TAGS),
    ("MobileNetV2", ["tissuemnist", "dermmnist", "octmnist"], TABLE_TAGS),
    ("RegNetY400MF", ["tissuemnist", "dermmnist", "octmnist"], TABLE_TAGS),
    ("ViTB16", ["octmnist"], TABLE_TAGS),
]
