"""Aggregate G2 — asymmetric tightness on TissueMNIST + AIDER."""
import csv
from pathlib import Path
from agg_common import collect_sweep, write_csv, summarize, REPO

SWEEP = "results/pending_runs/g2_asym_tissue_aider"
OUT_RAW = REPO / "paper/HANDOFF/tables/g2_asym_tissue_aider_raw.csv"
OUT_SUM = REPO / "paper/HANDOFF/tables/g2_asym_tissue_aider_summary.csv"
GROUP_KEYS = ["ds", "model", "cls", "grp", "tight"]


def main():
    rows = collect_sweep(SWEEP, phase_tag="g2_asym_tissue_aider")
