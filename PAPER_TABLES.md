...
| K %      | metric          | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|----------|-----------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| L20_G20  | F1 macro        | 0.3625 ± 0.015     | **0.3734 ± 0.012**  | 0.3565 ± 0.005      | 0.3423 ± 0.024      | 0.3419 ± 0.024      |
|          | F1 constrained  | **0.1821 ± 0.020** | 0.1691 ± 0.025      | 0.1239 ± 0.014      | 0.1659 ± 0.020      | 0.1626 ± 0.025      |
| L30_G30  | F1 macro        | 0.3586 ± 0.011     | **0.3672 ± 0.014**  | 0.3563 ± 0.006      | 0.3565 ± 0.031      | 0.3563 ± 0.031      |
|          | F1 constrained  | 0.2309 ± 0.027     | 0.1979 ± 0.042      | 0.1237 ± 0.043      | **0.2324 ± 0.041**  | 0.2306 ± 0.040      |
| L40_G40  | F1 macro        | **0.3767 ± 0.010** | 0.3754 ± 0.012      | 0.3639 ± 0.014      | 0.3545 ± 0.026      | 0.3549 ± 0.025      |
|          | F1 constrained  | **0.2698 ± 0.035** | 0.1941 ± 0.068      | 0.1593 ± 0.051      | 0.2594 ± 0.034      | 0.2594 ± 0.030      |
| L50_G50  | F1 macro        | 0.3737 ± 0.018     | **0.3755 ± 0.009**  | 0.3612 ± 0.012      | 0.3651 ± 0.030      | 0.3651 ± 0.030      |
|          | F1 constrained  | **0.3048 ± 0.034** | 0.2333 ± 0.035      | 0.1746 ± 0.045      | 0.3004 ± 0.046      | 0.2989 ± 0.044      |
| L60_G60  | F1 macro        | 0.3714 ± 0.013     | **0.3762 ± 0.021**  | 0.3636 ± 0.015      | 0.3612 ± 0.028      | 0.3610 ± 0.030      |
|          | F1 constrained  | **0.3181 ± 0.022** | 0.2214 ± 0.090      | 0.2295 ± 0.095      | 0.3101 ± 0.038      | 0.3077 ± 0.041      |
| L70_G70  | F1 macro        | **0.3780 ± 0.014** | 0.3754 ± 0.013      | 0.3678 ± 0.015      | 0.3691 ± 0.027      | 0.3674 ± 0.027      |
|          | F1 constrained  | **0.3393 ± 0.031** | 0.2651 ± 0.063      | 0.2481 ± 0.078      | 0.3382 ± 0.030      | 0.3232 ± 0.019      |
| L80_G80  | F1 macro        | **0.3806 ± 0.021** | 0.3729 ± 0.011      | 0.3770 ± 0.024      | 0.3626 ± 0.027      | 0.3632 ± 0.026      |
|          | F1 constrained  | **0.3314 ± 0.040** | 0.2729 ± 0.084      | 0.2601 ± 0.096      | 0.3312 ± 0.036      | 0.3358 ± 0.032      |

**Take-away:** TraLO wins macro F1 on the loose half (L40-L80) and ties or wins F1_constrained at every tightness level. Hounie wins macro F1 in the very-tight regime (L20-L30) — at the cost of much lower F1 constrained. heuristic ≈ danits_lp throughout (within ±0.01) — both share the warmup model and differ only in posthoc allocation algorithm.

---

## Table 4 — Multi-class constraints, TissueMNIST L50_G50, MobileNetV3, 3 seeds

| classes constrained | metric        | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|---------------------|---------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| {4} (single)        | F1 macro      | 0.3737 ± 0.018     | **0.3755 ± 0.009**  | 0.3612 ± 0.012      | 0.3651 ± 0.030      | 0.3651 ± 0.030      |
| {3, 4}              | F1 macro      | **0.3753 ± 0.022** | 0.3596 ± 0.014      | 0.3368 ± 0.006      | 0.3461 ± 0.027      | 0.3467 ± 0.027      |
| {4, 1}              | F1 macro      | **0.3772 ± 0.023** | 0.3693 ± 0.017      | 0.3643 ± 0.017      | 0.3607 ± 0.029      | 0.3585 ± 0.031      |
| {1, 4, 7}           | F1 macro      | **0.3776 ± 0.024** | 0.3625 ± 0.018      | 0.3436 ± 0.014      | 0.3607 ± 0.030      | 0.3579 ± 0.032      |

| classes constrained | metric        | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|---------------------|---------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| {3, 4}              | F1 const. avg | **0.357 ± 0.048**  | 0.298 ± 0.027       | 0.237 ± 0.021       | 0.334 ± 0.056       | 0.335 ± 0.056       |
| {4, 1}              | F1 const. avg | 0.180 ± 0.044      | 0.151 ± 0.057       | 0.131 ± 0.059       | **0.189 ± 0.055**   | 0.178 ± 0.069       |
| {1, 4, 7}           | F1 const. avg | 0.209 ± 0.030      | 0.161 ± 0.026       | 0.132 ± 0.010       | **0.217 ± 0.036**   | 0.204 ± 0.042       |

**Take-away:** TraLO wins macro F1 on every multi-class scenario, by 1.6-3.4 pp over Hounie and 1.3-4.0 pp over Fioretto. Margin grows with the number of constrained classes — multi-class is TraLO's strongest regime. heuristic edges TraLO on F1_const for {4,1} and {1,4,7} by 0.8-0.9 pp, but at the cost of 1.7-3.4 pp lower macro F1.
...
| (L%, G%)  | metric         | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|-----------|----------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| (30, 70)  | F1 macro       | 0.3653 ± 0.018     | **0.3701 ± 0.012**  | 0.3690 ± 0.017      | 0.3492 ± 0.029      | 0.3488 ± 0.028      |
|           | F1 constrained | **0.2285 ± 0.049** | 0.2001 ± 0.044      | 0.1725 ± 0.093      | 0.2162 ± 0.048      | 0.2132 ± 0.043      |
| (70, 30)  | F1 macro       | **0.3745 ± 0.018** | 0.3669 ± 0.006      | 0.3646 ± 0.013      | 0.3477 ± 0.025      | 0.3478 ± 0.026      |
|           | F1 constrained | **0.2274 ± 0.047** | 0.2002 ± 0.038      | 0.1549 ± 0.071      | 0.2072 ± 0.027      | 0.2072 ± 0.032      |
...
| K %     | metric         | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|---------|----------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| L30_G30 | F1 macro       | 0.7396 ± 0.006     | **0.7405 ± 0.009**  | 0.7400 ± 0.008      | 0.7190 ± 0.017      | 0.7190 ± 0.017      |
|         | F1 constrained | **0.4221 ± 0.012** | 0.4207 ± 0.012      | 0.3815 ± 0.015      | 0.4124 ± 0.010      | 0.4124 ± 0.010      |
|         | ECE ↓          | 0.1122 ± 0.004     | 0.1314 ± 0.004      | 0.1294 ± 0.004      | **0.1044 ± 0.010**  | **0.1044 ± 0.010**  |
|         | Brier ↓        | **0.2374 ± 0.007** | 0.2734 ± 0.006      | 0.2789 ± 0.006      | 0.2371 ± 0.014      | 0.2371 ± 0.014      |
| L70_G70 | F1 macro       | **0.7864 ± 0.012** | 0.7809 ± 0.009      | 0.7826 ± 0.006      | 0.7602 ± 0.017      | 0.7600 ± 0.017      |
|         | F1 constrained | **0.6352 ± 0.016** | 0.6345 ± 0.012      | 0.6158 ± 0.019      | 0.6227 ± 0.037      | 0.6227 ± 0.037      |
|         | ECE ↓          | 0.1031 ± 0.004     | **0.1030 ± 0.004**  | 0.1060 ± 0.006      | 0.1044 ± 0.010      | 0.1044 ± 0.010      |
|         | Brier ↓        | 0.2248 ± 0.007     | **0.2240 ± 0.008**  | 0.2306 ± 0.008      | 0.2371 ± 0.014      | 0.2371 ± 0.014      |
...
| K %     | metric         | TraLO              | Hounie              | Fioretto            | heuristic           | danits_lp           |
|---------|----------------|--------------------|---------------------|---------------------|---------------------|---------------------|
| L30_G30 | F1 macro       | 0.9093 ± 0.001     | **0.9097 ± 0.001**  | 0.9034 ± 0.003      | 0.9050 ± 0.003      | 0.9054 ± 0.003      |
|         | F1 constrained | **0.4589 ± 0.000** | **0.4589 ± 0.000**  | 0.4177 ± 0.012      | 0.4560 ± 0.005      | 0.4560 ± 0.005      |
|         | accuracy       | 0.9349 ± 0.001     | **0.9356 ± 0.000**  | 0.9304 ± 0.003      | 0.9310 ± 0.003      | 0.9310 ± 0.003      |
| L70_G70 | F1 macro       | 0.9592 ± 0.001     | **0.9604 ± 0.001**  | 0.9568 ± 0.004      | 0.9542 ± 0.004      | 0.9541 ± 0.004      |
|         | F1 constrained | **0.8212 ± 0.000** | **0.8212 ± 0.000**  | 0.8055 ± 0.022      | 0.8146 ± 0.007      | 0.8146 ± 0.007      |
|         | accuracy       | 0.9647 ± 0.001     | **0.9660 ± 0.001**  | 0.9629 ± 0.003      | 0.9601 ± 0.003      | 0.9601 ± 0.003      |
