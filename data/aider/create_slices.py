"""5 stratified slices of AIDER -- mirrors eurosat/tissuemnist protocol.
Reads pooled train+test from this dir, creates slice_{1..5}/ subdirs.
"""
import os
...
NUM_CLASSES = 4
CLASS_NAMES = {
    0: "collapsed_building", 1: "fire", 2: "flooded_areas", 3: "normal",
}
