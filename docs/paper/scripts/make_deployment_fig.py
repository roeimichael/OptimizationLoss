...
Source: docs/paper/data/corpus/corpus_final.csv, sweep=='paper_final'.
  columns used: model {MobileNetV3, RegNetY400MF, ViTB16}, method, dataset, sat

Run:  python docs/paper/scripts/make_deployment_fig.py
"""
...
SRC = os.path.join(ROOT, "data", "corpus", "corpus_final.csv")
