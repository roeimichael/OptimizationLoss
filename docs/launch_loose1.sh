#!/usr/bin/env bash
# =============================================================================
# 🛑🛑 SUPERSEDED 2026-09-01 -- 1 OF ITS 6 (backbone x cap) CELLS POSE
...
# =============================================================================
# =============================================================================
#  results/loose1  --  THE FIRST CAP REGIME WHERE A WIN COULD BE SEEN
# =============================================================================
#
...
#
#   size        6 cells x 6 arms x 4 seeds = 144 runs
#               6 cells is 3 backbones x 2 caps, so the exact sign-test floor
#               is 1/32 = 0.031 and a 6-of-6 sweep IS callable -- unlike
#               vitu1's 3 cells, whose floor is 0.25.
#
#   host        dsisco02 (RTX PRO 6000 Blackwell, BF16 AMP), GPU 0.
#               ViTB16 runs the same two caps as `loosevit1` on dsisco01.
#
#   read it     python -m scripts.rig_status
#               python -m scripts.dose_landed results/loose1
#               python -m scripts.paired_noise --campaign results/loose1
...
#               python -m scripts.full_panel --campaign results/loose1 --control clip
...
TREE=~/optloss-loose         # its OWN worktree. Worktrees share one object
...
#
#     git show origin/headroom/small-cnn:docs/launch_loose1.sh > ~/launch_loose1.sh
#     GPU=0 bash ~/launch_loose1.sh
#
...
echo "loosevit1 takes the other one on dsisco01: this is the second and last."
