...
| `bcn1vit` | live, **L90 only** | **ViTB16** | `L90` | `L70` and `L80` were archived as non-task to `~/optloss-archive-bcn1vit-L70-nontask-2026-09-09` (moved, not deleted). L90 is a task cell under both readings -- finish it. 2(z58) |
