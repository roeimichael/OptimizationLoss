...
six restored baselines, six new gate scripts, and 156 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (156 tests, ~35 s, no dataset needed).
...
tests/             156 tests, ~35 s, no dataset required
