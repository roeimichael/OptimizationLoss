...
six restored baselines, five new gate scripts, and 124 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (124 tests, ~19 s, no dataset needed).
...
tests/             124 tests, ~19 s, no dataset required
