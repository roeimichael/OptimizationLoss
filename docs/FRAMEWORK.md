...
six restored baselines, six new gate scripts, and 210 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (210 tests, ~40 s, no dataset needed).
...
tests/             210 tests, ~40 s, no dataset required
