...
six restored baselines, six new gate scripts, and 171 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (171 tests, ~35 s, no dataset needed).
...
tests/             171 tests, ~35 s, no dataset required
