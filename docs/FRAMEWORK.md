...
six restored baselines, six new gate scripts, and 163 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (163 tests, ~35 s, no dataset needed).
...
tests/             163 tests, ~35 s, no dataset required
