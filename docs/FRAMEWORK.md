...
six restored baselines, six new gate scripts, and 350 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (350 tests, ~105 s, no dataset needed).
...
tests/             350 tests, ~105 s, no dataset required
