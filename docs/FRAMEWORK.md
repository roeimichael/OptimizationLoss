...
six restored baselines, six new gate scripts, and 244 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (244 tests, ~85 s, no dataset needed).
...
tests/             244 tests, ~85 s, no dataset required
