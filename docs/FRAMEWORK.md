...
six restored baselines, six new gate scripts, and 349 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (349 tests, ~105 s, no dataset needed).
...
tests/             349 tests, ~105 s, no dataset required
