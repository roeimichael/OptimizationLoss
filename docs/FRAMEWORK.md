...
six restored baselines, five new gate scripts, and 140 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (140 tests, ~19 s, no dataset needed).
...
tests/             140 tests, ~19 s, no dataset required
