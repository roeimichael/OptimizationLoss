...
six restored baselines, six new gate scripts, and 246 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (246 tests, ~105 s, no dataset needed).
...
tests/             246 tests, ~105 s, no dataset required
