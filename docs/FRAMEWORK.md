...
six restored baselines, six new gate scripts, and 211 tests. **Do not quote a line count as a
...
no cross-objective warm-up sharing), and `pytest tests` (211 tests, ~40 s, no dataset needed).
...
tests/             211 tests, ~40 s, no dataset required
