...
Data source: docs/paper/data/dynamics/dermmnist/*/symmetric/RegNetY400MF/L30_G30/
(self-contained; see data/README_DATA.md). Constrained class 4 (melanoma).

Run:  python docs/paper/scripts/make_convergence_fig.py
"""
