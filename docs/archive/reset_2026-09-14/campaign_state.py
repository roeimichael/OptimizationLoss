"""ARCHIVED: historical prose audit, not a current operational tool.
...
if __name__ == "__main__":
    raise SystemExit("Archived after the 2026-09-14 evidence reset; use docs/MISSION.md for current state.")
