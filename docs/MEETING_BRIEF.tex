...
introduced with no citation at all (now Bertsekas 1982).
...
\item \textbf{A blue sentence in \S5.1 says ``the eight tight-cap cells''} where the rest of
the paper says six; the difference is the added MobileNetV2, but it is never stated.
