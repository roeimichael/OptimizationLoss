"""Backbone-robustness sweep on Derm cls 5 (NV majority) — second TraLO win cell.

Mirror of gen_aider_cls3_backbones.py for the derm majority class.
Tests whether the d_F1 +0.016 vs LP+heuristic generalizes across 4 backbones.

Layout: 1 dataset × 1 class (5) × 4 backbones × 5 methods × 5 seeds × L30_G30 = 100 cells.
"""
...
def make_cfg(backbone, seed, method):
    ds_config = {
        ...
        "group_column": "loc_group", "constrained_class": CONSTRAINED_CLASS,
    ...
    return {
        ...
        "experiment_path": (
            f"results/pending_runs/derm_cls5_backbones/"
