"""AIDER cls 3 L20_G20 across all 4 backbones — tightness × backbone robustness.

At L20, AIDER cls 3 has d_F1 vs heuristic = +0.074 paired-sig (MobileNetV3).
This sweep confirms the effect across MobileNetV2, RegNetY400MF, ShuffleNetV2.

4 backbones × 5 methods × 5 seeds × L20_G20 = 100 cells.
"""
...
def make_cfg(backbone, seed, method):
    ds_config = {
        ...
        "group_column": "synth_group", "constrained_class": 3,
    ...
    return {
        ...
        "experiment_path": (
            f"results/pending_runs/aider_cls3_l20_backbones/"
